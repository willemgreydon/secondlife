        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm">
              <li>
                <Link href="/tide" className="hover:underline">TIDE</Link>
              </li>
              <li>
                <Link href="/missions" className="hover:underline">Missions</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/data-access-portability" className="hover:underline">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-sm">
              <li>
                <a href="mailto:media@secondlife.ngo" className="hover:underline">
                  Email Us
                </a>
              </li>
              <li>
                <a
                  href="https://www.linkedin.com/company/second-life42"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li>
                <a
                  href="https://www.instagram.com/secondlife.ngo"
                  target="_blank"
                  rel="noreferrer"
                  className="hover:underline"
                >
              ...
              <li>
                <a
                  href="https://www.youtube.com/@SecondLifeE.V"
                  target="_blank"
                  rel="noreferrer"
                  className="hover:underline"
                >
