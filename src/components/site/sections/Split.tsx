...
type Side = { kind: "text"; text?: any[]; image?: any; alt?: string } | { kind: "image"; image?: any; alt?: string; text?: any[] };
...
export default function Split(props: SplitProps) {
  const { title, layout = "50-50", reversed, left, right } = props;
  const cols = layout === "40-60" ? "md:grid-cols-[2fr_3fr]" : layout === "60-40" ? "md:grid-cols-[3fr_2fr]" : "md:grid-cols-2";
